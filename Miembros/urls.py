...
urlpatterns = [
    ...
    path('personas_sinusuario/', ListarPersonasSinUsuarioView.as_view(), name='listar_personas_sin_usuario'),
    path('personas_usuario/', ListarPersonasConUsuarioView.as_view(), name='listar_personas_usuario'),
